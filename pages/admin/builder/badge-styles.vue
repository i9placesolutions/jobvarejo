...
<template>
  ...
  <div class="admin-page admin-page--builder">
    <div class="mx-auto max-w-6xl px-6 py-10">
      ...
      <!-- Table -->
      <div v-else-if="badges.length && !showForm" class="overflow-x-auto rounded-lg border border-[color:var(--jv-line)]" role="region" aria-label="Tabela de registros — deslize para ver todas as colunas" tabindex="0">
        <table class="w-full text-left text-sm">
          <thead class="bg-[#f3f8fd]">
            <tr>
              ...
              <th class="px-4 py-3 font-medium text-slate-600">Global</th>
          ...
          <tbody class="bg-white">
            <tr v-for="badge in badges" :key="badge.id" class="border-t border-[color:var(--jv-line)]">
              <td class="px-4 py-3">
                <span
              ...
              <td class="px-4 py-3 font-medium text-[color:var(--jv-ink)]">{{ badge.name }}</td>
              <td class="px-4 py-3">
                <span
              ...
              <td class="px-4 py-3 text-[color:var(--jv-muted)]">{{ badge.sort_order }}</td>
      ...
      <div v-else-if="!badges.length && !showForm && !isLoading" class="text-center py-12 text-[color:var(--jv-muted)]">
      ...
      >
        <div class="rounded-xl border border-[color:var(--jv-line)] bg-[#f3f8fd] p-6 shadow-xl max-w-sm w-full mx-4">
          ...
          <p class="mt-2 text-sm text-[color:var(--jv-muted)]">Tem certeza que deseja excluir este selo?</p>
      ...
      <div v-if="showForm" class="rounded-xl border border-[color:var(--jv-line)] bg-white p-6">
        ...
        <form @submit.prevent="saveBadge" class="space-y-4">
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              <label class="block text-xs font-medium text-[color:var(--jv-muted)] mb-1">Texto do Selo</label>
              <input
                v-model="form.text"
                type="text"
                class="w-full rounded-lg border border-[color:var(--jv-line)] bg-[#f3f8fd] px-3 py-2 text-sm text-[color:var(--jv-navy)] placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
          ...
          <div>
            ...
            <div class="relative inline-block rounded-lg border border-[color:var(--jv-line)] bg-[color:var(--jv-sky)] w-32 h-24">
              <span
              ...
              <div class="flex items-center justify-center h-full text-xs text-[color:var(--jv-muted)]">
                Produto
              </div>
            </div>
          </div>
