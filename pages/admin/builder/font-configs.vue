...
<template>
  <div class="min-h-screen bg-zinc-950 text-zinc-100">
    <div class="mx-auto max-w-6xl px-6 py-10">
      ...
      <!-- Table -->
      <div v-else-if="fonts.length && !showForm" class="overflow-x-auto rounded-lg border border-zinc-800" role="region" aria-label="Tabela de registros — deslize para ver todas as colunas" tabindex="0">
