...
<style scoped>
.business-profile-page { background: #f3f7fb; color: #172b45; }
...
.brand { display: flex; align-items: center; gap: 10px; flex: 1; }.brand__mark { width: 34px; height: 34px; display: grid; place-items: center; color: #2160b4; background: #eaf3ff; border: 1px solid #c8dcf4; border-radius: 9px; }.brand strong, .brand small { display: block; }.brand strong { font-size: 14px; }.brand small { color: #64748b; font-size: 10px; margin-top: 2px; }.back-link { color: #173d70; text-decoration: none; font-size: 12px; font-weight: 800; }
.page-main { max-width: 900px; margin: 0 auto; padding: 38px 24px 64px; }.page-intro p, .surface-title p { color: #2160b4; font-size: 10px; letter-spacing: .13em; font-weight: 800; margin: 0 0 7px; }.page-intro h1 { font-size: 32px; line-height: 1.05; margin: 0; }.page-intro span { display: block; color: #64748b; font-size: 13px; margin-top: 9px; }
