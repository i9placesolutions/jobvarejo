...
const returnLabel = computed(() => {
  if (returnTo.value.startsWith('/editor/')) return 'Voltar ao editor'
  if (returnTo.value.startsWith('/flyer-templates')) return 'Voltar para Encartes'
  return 'Voltar para os projetos'
})
