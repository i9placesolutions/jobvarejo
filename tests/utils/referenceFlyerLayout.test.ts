...
describe('layout fiel à referência de varejo',()=>{
 it('compõe quinta-feira com data numérica e estoques na segunda linha',()=>{
  ...
  expect(splitFooterValidityText({layout:'reference-ribbon',mode:'while_stocks',dateFormat:'hidden'})).toEqual({heading:'',period:'',stock:''})
  expect(splitFooterValidityText({layout:'reference-ribbon',mode:'date_range',startDate:'2026-09-24',endDate:'2026-09-25',dateFormat:'long'}).period).toBe('24 A 25 DE SETEMBRO OU ENQUANTO DURAREM OS ESTOQUES')
