...
import { newVideoDocument,parseOfferPrice,videoAudioIdentity,videoSpeechSource,suggestVideoScripts,narrationScripts,videoNarrationText,buildVideoTimeline,validateVideoForGeneration } from '../../shared/video-studio/model'
