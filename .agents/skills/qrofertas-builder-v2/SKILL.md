...
1. Classifique o pedido:
   - Auditoria ou descoberta do produto: ler [references/live-audit.md](references/live-audit.md).
   - Funcao por funcao ou cobertura detalhada: ler [references/function-matrix.md](references/function-matrix.md).
   - Alteracao no repo local: ler [references/repo-map.md](references/repo-map.md) e depois abrir os arquivos do dominio afetado.
   - Especificacao funcional mais ampla do projeto: ler [references/spec.md](references/spec.md).
...
1. Ler [references/repo-map.md](references/repo-map.md).
...
Abrir [references/repo-map.md](references/repo-map.md) quando precisar sair da auditoria e entrar em codigo.
...
- [references/function-matrix.md](references/function-matrix.md)
...
- [references/live-audit.md](references/live-audit.md)
- [references/function-matrix.md](references/function-matrix.md)
...
- [references/live-audit.md](references/live-audit.md): inventario geral do builder vivo.
- [references/function-matrix.md](references/function-matrix.md): matriz operacional do front, funcao por funcao.
- [references/repo-map.md](references/repo-map.md): mapa entre o builder externo e os arquivos do repo local.
- [references/spec.md](references/spec.md): especificacao funcional mais ampla usada no projeto.
