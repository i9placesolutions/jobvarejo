...
try {
 ...
 for(const row of ledger){
  ...
  doc.templateRevision=r.revision;doc.transition=r.transition;doc.motion={...doc.motion,...r.motion};
 ...
 await writeFile(dir+'/thematic-v18-projects.json',JSON.stringify(changed,null,2));
