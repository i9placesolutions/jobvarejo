    ...
    return {
        ...
        zone: {
            ...
            layout: {
                ...
                structureByProductCountEnabled: zone?.structureByProductCountEnabled === true,
                structureByProductCount: clonePlainForZoneSnapshot(zone?.structureByProductCount ?? null),
                structureByProductCountByPreviewFormat: clonePlainForZoneSnapshot(zone?.structureByProductCountByPreviewFormat ?? null),
                structureVariantsByProductCount: clonePlainForZoneSnapshot(zone?.structureVariantsByProductCount ?? null),
                structureVariantsByProductCountByPreviewFormat: clonePlainForZoneSnapshot(zone?.structureVariantsByProductCountByPreviewFormat ?? null),
                structureVariantByProductCount: clonePlainForZoneSnapshot(zone?.structureVariantByProductCount ?? null),
                structureVariantByProductCountByPreviewFormat: clonePlainForZoneSnapshot(zone?.structureVariantByProductCountByPreviewFormat ?? null),
                highlightCount: finiteZoneSnapshotNumber(zone?.highlightCount),
                highlightPos: zone?.highlightPos ?? 'first',
                highlightSelection: zone?.highlightSelection ?? zone?.highlightPos ?? 'first',
                highlightIndexes: clonePlainForZoneSnapshot(zone?.highlightIndexes ?? [1]),
